...
while True:
  ...
  if (len(marca_carro.split()) <= 0):
    print('A marca do carro não pode ficar vazio, digite novamente.')
  else:
...
while True:
  ...
  if (len(modelo_carro.split()) <= 0):
    print('O modelo do carro não pode ficar vazio, digite novamente.')
  else:
...
while True:
  ...
  if (len(cor_carro.split()) <= 0):
    print('A cor do carro não pode ficar vazio, digite novamente.')
  else:
